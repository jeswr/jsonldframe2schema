...
def parse_manifest_with_rdflib(manifest_url: str, manifest_doc: Dict[str, Any]) -> Graph:
    """
...
def extract_test_info_from_expanded(test: Dict[str, Any], base_url: str) -> Dict[str, Any]:
    """
    ...
    is_positive = "https://w3c.github.io/json-ld-api/tests/vocab#PositiveEvaluationTest" in test_types
    is_negative = "https://w3c.github.io/json-ld-api/tests/vocab#NegativeEvaluationTest" in test_types
    ...
    input_path = get_relative_path("https://w3c.github.io/json-ld-api/tests/vocab#input")
    frame_path = get_relative_path("https://w3c.github.io/json-ld-api/tests/vocab#frame")
    expect_path = get_relative_path("https://w3c.github.io/json-ld-api/tests/vocab#expect")
    expect_error = get_value("https://w3c.github.io/json-ld-api/tests/vocab#expectErrorCode")
...
def extract_tests_from_expanded(expanded: List[Dict[str, Any]], base_url: str) -> List[Dict[str, Any]]:
    """
    ...
    for node in expanded:
        ...
        sequence_key = "http://www.w3.org/2001/sw/DataAccess/tests/test-manifest#entries"
                ...
                if isinstance(item, dict) and "@list" in item:
                    for test_entry in item["@list"]:
                        if isinstance(test_entry, dict):
                            test_info = extract_test_info_from_expanded(test_entry, base_url)
